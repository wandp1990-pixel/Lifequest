...
async function seedGameConfig(db: Client) {
  ...
  const data: [string, string, string][] = [
    ...
    ["monster_grade_C_prob", "50.0", "잡몹 출현 확률"],
    ["monster_grade_B_prob", "20.0", "정예 출현 확률"],
    ["monster_grade_A_prob", "15.0", "희귀 출현 확률"],
    ["monster_grade_S_prob", "8.0", "네임드 출현 확률"],
    ["monster_grade_SR_prob", "4.0", "필드보스 출현 확률"],
    ["monster_grade_SSR_prob", "1.5", "재앙 출현 확률"],
...
async function seedItemGradeTable(db: Client) {
  const data = [
    ...
    ["B", "고급", 1, "0~1", "0", "0", "1~2", 12, 20, 25.0],
    ["A", "희귀", 1, "1", "0~1", "0", "2~3", 20, 35, 15.0],
    ["S", "영웅", 1, "1", "1", "0", "3", 35, 60, 6.0],
    ["SR", "전설", 1, "1", "1~2", "0", "3~4", 60, 100, 3.0],
    ["SSR", "고대", 1, "1", "2", "0~1", "4~5", 100, 170, 0.9],
    ["UR", "신화", 1, "1", "2", "1", "5", 170, 300, 0.1],
  ]
