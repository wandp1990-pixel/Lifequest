...
const MOCK_SKILLS: Skill[] = [
  // Active (낮은 레벨부터)
  { id: "ACTIVE_RAGE_01",         name: "분노",       type: "active",  unlock_level: 3,  base_effect_value: 18, effect_coeff: 3.5,  mp_cost: 20, mp_cost_coeff: 1,    trigger_condition: "전투 시작",   effect_code: "PATK_PCT", description: "물리 ATK 증가", invested: 5,  max_skp: 20 },
  { id: "ACTIVE_CHAIN_01",        name: "연속공격",   type: "active",  unlock_level: 5,  base_effect_value: 30, effect_coeff: 2.5,  mp_cost: 10, mp_cost_coeff: 0.5,  trigger_condition: "명중 시",    effect_code: "EXTRA_HIT", description: "추가 타격 발동", invested: 0,  max_skp: 20 },
  { id: "ACTIVE_FIRST_STRIKE_01", name: "선제 강타",  type: "active",  unlock_level: 9,  base_effect_value: 12, effect_coeff: 2.5,  mp_cost: 15, mp_cost_coeff: 0.75, trigger_condition: "선공 획득",  effect_code: "PATK_PCT", description: "물리 ATK 증가", invested: 0,  max_skp: 20 },
  ...
  { id: "ACTIVE_MANA_BURST_01",   name: "마나 폭발",  type: "active",  unlock_level: 25, base_effect_value: 30, effect_coeff: 5,    mp_cost: 25, mp_cost_coeff: 1.25, trigger_condition: "매 3턴",     effect_code: "MATK_PCT", description: "마법 ATK 증가", invested: 0,  max_skp: 20 },
  { id: "ACTIVE_SPARK_01",        name: "지식의 불꽃", type: "active", unlock_level: 28, base_effect_value: 22, effect_coeff: 4,    mp_cost: 10, mp_cost_coeff: 0.5,  trigger_condition: "치명타 시",  effect_code: "MATK_PCT", description: "마법 ATK 증가", invested: 0,  max_skp: 20 },
